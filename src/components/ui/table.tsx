// ---------------------------------------------------------------------
// <copyright file="table.tsx" company="iGnosis Tech">
...
>(({ className, ...props }, ref) => (
  <th
    ref={ref}
    className={cn(
      'h-11 px-3 text-left text-xs font-semibold uppercase tracking-wide text-slate-500',
      className
    )}
    {...props}
  />
...
>(({ className, ...props }, ref) => (
  <td ref={ref} className={cn('h-14 px-3 align-middle text-sm text-slate-700', className)} {...props} />
))
